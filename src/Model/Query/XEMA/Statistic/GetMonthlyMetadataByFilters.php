 ...
 */
final class GetMonthlyMetadataByFilters extends Base
{
    /**
     * Endpoint.
     */
    private const URI = '/estacions/{codi_estacio}/variables/estadistics/mensuals/{codi_variable}/metadades';
    ...
    /**
     * GetMonthlyMetadataByFilters constructor.
     *
    ...
    {
        return parent::getName() . "/GetMonthlyMetadataByFilters";
    }
